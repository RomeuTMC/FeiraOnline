...
<?php include_once(_FS.'/_parts/_header_cliente.php'); ?>

<div class="container mt-5 d-flex flex-row">
  <div class="col mx-auto">
    <div class="table-responsive">
      <form method="POST" action="<?php echo(URL."cliente/save/".$dados['nId']);?>" id="id_form_clientes" class="mb-5" name="form_clientes">
      <fieldset class="frm_field">
        <h1 class='form_title font-weight-bold color-pink'>Primary Buyer Delegate Information</h1>
              ...
              <div class="form-group p-2">
                ...
                <input type="text" class="form-control" id="id_cCompany" name="cCompany" value="<?php echo($dados['cCompany']);?>" maxlength=250 required>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Address</label>
                <input type="text" class="form-control" id="id_cAddress" name="cAddress" value="<?php echo($dados['cAddress']);?>" maxlength=255 required>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">City</label>
                <input type="text" class="form-control" id="id_cCity" name="cCity" value="<?php echo($dados['cCity']);?>" maxlength=150 required>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Post Code</label>
                <input type="text" class="form-control" id="id_cCEP" name="cCEP" value="<?php echo($dados['cCEP']);?>" maxlength=12 required>
              </div>
              <div class="form-group p-2">
              ...
              <div class="form-group p-2">
                ...
                <input type="text" class="form-control" id="id_cPersonalName" name="cPersonalName" value="<?php echo($dados['cPersonalName']);?>" maxlength=250 required>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Job Title (for Credential)</label>
                <input type="text" class="form-control" id="id_cCargo" name="cCargo" value="<?php echo($dados['cCargo']);?>" maxlength=150 required>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Mail (for Credential and Login)</label>
                <input type="email" class="form-control" id="id_cEmail" name="cEmail" value="<?php echo($dados['cEmail']);?>" maxlength=200 required>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Password *</label>
                <input type="password" class="form-control" id="id_cPassw" name="cPassw" value="<?php echo($dados['cPassw']);?>" maxlength=200 required placeholder='Digite uma senha'  autocomplete="new-password">
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Retype Password *</label>
                <input type="password" class="form-control" id="id_cPasswR" name="cPasswR" value="" maxlength=200 required placeholder='Re-digite sua senha' autocomplete="new-password">
              </div>
        </fieldset>
        <fieldset class="frm_field">
        <!-- <legend>Buyer Questionnaire</legend> -->
        <legend class="color-pink font-weight-bold">Buyer Questionnaire</legend>
              <div class="form-group p-2">
              ...
              <p class='form_subtitle color-pink font-weight-bold text-uppercase'>Name 5 existing service Suppliers/Sellers you are currently working with in the asia pacific region</p>
              <div class="form-group p-2">
              ...
              <p class='form_subtitle color-pink font-weight-bold text-uppercase'>Name 5 Countries/Destinations you are currently sending business to the asia pacifc region</p>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Country 1</label>
                <?php mk_select('cCountry1',$dados['cCountry1'],$dados['cCountry_asia']); ?>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Country 2</label>
                <?php mk_select('cCountry2',$dados['cCountry2'],$dados['cCountry_asia']); ?>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Country 3</label>
                <?php mk_select('cCountry3',$dados['cCountry3'],$dados['cCountry_asia']); ?>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Country 4</label>
                <?php mk_select('cCountry4',$dados['cCountry4'],$dados['cCountry_asia']); ?>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Country 5</label>
                <?php mk_select('cCountry5',$dados['cCountry5'],$dados['cCountry_asia']); ?>
              </div>
              <!-- <h3 class='message-title'>Name 5 Country/Destinations you are planning to develop business to asia pacifc region</h3> -->
              <p class='form_subtitle color-pink font-weight-bold text-uppercase'>Name 5 Country/Destinations you are planning to develop business to asia pacifc region</p>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Destination 1</label>
                <?php mk_select('cDestino1',$dados['cDestino1'],$dados['cCountry_asia']); ?>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Destination 2</label>
                <?php mk_select('cDestino2',$dados['cDestino2'],$dados['cCountry_asia']); ?>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Destination 3</label>
                <?php mk_select('cDestino3',$dados['cDestino3'],$dados['cCountry_asia']); ?>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Destination 4</label>
                <?php mk_select('cDestino4',$dados['cDestino4'],$dados['cCountry_asia']); ?>
              </div>
              <div class="form-group p-2">
                <label for="message-text" class="col-form-label">Destination 5</label>
                <?php mk_select('cDestino5',$dados['cDestino5'],$dados['cCountry_asia']); ?>
              </div>
              <div class="form-group p-2">
        ...
        <?php } else { ?>
        <a class="btn btn-secondary d-none" onclick="ClickCancel()" >Cancelar</a>
        <button type='submit' class="btn btn-primary border-0 btn-save">Salvar</button>
        <?php
        } //fim do echo mostra
        ?>
        </div>
...
function ClickCancel(){
  Swal.fire({
        title: "Confirm?",
        html: "On Confirm, <b>ALL</b> updates was lost. Ok?",
        icon: "warning",
      ...
      .then((result) => {
        if (result.value) {
          spinner.show();
          window.location.href = "<?php echo("/clientes"); ?>"
        }
      });
}

$("#id_form_clientes").validate({
