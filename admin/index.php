...
//make LOG
$cpath='admin/'.implode('/',$_SESSION['route']);
$login='GUEST';
    ...
    <section>
     ...
     <footer>
          <div class="footer d-none">
            <?php
                require_once(_FS."/admin/_rodape.php"); // Finaliza o script fechando as conexões e dando a saida do DEBUG
            ?>
          </div>
     </footer>
</body>
