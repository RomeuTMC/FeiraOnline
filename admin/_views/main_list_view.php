          ...
          <div class="container">
            <div class="row">
              <div class="col-md-9 col-lg-8 mx-auto">
                ...
                <h3 class="login-heading color-pink text-center text-md-left font-weight-bold">Adm Login</h3>
                <h1 class="login-heading mb-4 color-pink text-center text-md-left font-weight-bold"><?php echo SISTEM;?>
                </h1>
                <form method="POST" action="<?php echo(ADMIN.'main/login'); ?>" id="formLogin">
                  ...
                  <button class="btn btn-lg btn-primary btn-block btn-login py-3 mb-2 border-0" type="submit">Log
                    in</button>
                </form>
